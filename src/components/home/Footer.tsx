...
export const Footer = () => {
	...
	return (
		<div className='w-full relative bottom-0 bg-[#111111] pt-20 pb-14 text-[14.88px]  text-white'>
			<div className='mr-0 flex flex-col px-[20px] min-[590px]:pl-[40px] md:flex-row md:justify-around md:pl-[0px] lg:mr-7'>
				...
				{Footerdata.map((item: any) => {
					return (
						<div
							className='hidden min-[590px]:inline'
							key={item.header}
						>
 ...
 */}
				...
				{Footerdata.map((item: any) => {
					return <FooterChild item={item} key={item.header} />;
				})}
				<div className='flex flex-col  md:w-72 '>
					<h2 className=' mt-5 font-bold uppercase'>
						{footsub.head}
					</h2>
