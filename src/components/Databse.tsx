...
export const topFeature =
{
    ...
    src: "/images/by-archetype.avif",
    alt: "LUXURIOUS DESIGN"
}
...
export const desFeature = [
    ...
    {
        id: 6,
        subTitle: "Compact mobile design",
    ...
    {
        id: 8,
        subTitle: "Designed for smooth animation",
    ...
    {
        id: 12,
        subTitle: ".MP4, YouTube and Vimeo support",
    ...
    {
        id: 25,
        subTitle: "Everything else and more",
    ...
    {
        id: 34,
        subTitle: "Additional templates (NEW)",
    ...
    {
        id: 36,
        subTitle: "Mobile-friendly zoom (NEW)",
    ...
    {
        id: 45,
        subTitle: "Product question form",
    ...
    {
        id: 48,
        subTitle: "Landing page template (NEW)",
...
export const rightFit =
{
    title: 'Is Motion the right fit for your store?',
    btn: "Learn More",
}
...
{
    title: 'Video guides',
    desc: "View more guides on our YouTube channel",
    YtVideo: "https://www.youtube.com/embed/L08ar8JHqQY"
}